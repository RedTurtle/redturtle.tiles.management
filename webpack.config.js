...
module.exports = () => {
    let config = {
        entry: {
            "management.min": path.resolve(__dirname, "resources/index.js"),
        },
    };
    ...
    config.output.path = path.resolve(
        __dirname,
        "src/redturtle/tiles/management/browser/static/bundles"
    );

    config.plugins.push(
        mf_config({
            name: "management",
            filename: "tiles-management-compiled.min.js",
            remote_entry: config.entry["management.min"],
            dependencies: {
