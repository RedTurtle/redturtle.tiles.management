...
from redturtle.tiles.management.testing import (  # noqa
...
class TestTilesManagement(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.news = api.content.create(
            type="News Item", title="Test news", container=self.portal
        )

    def test_view_available_for_documents(self):
        doc_view = api.content.get_view(
            name="tiles_management", context=self.document, request=self.request
        )
    ...
    def test_view_not_available_for_news(self):
        with self.assertRaises(InvalidParameterError):
            api.content.get_view(
                name="tiles_management", context=self.news, request=self.request
            )
    ...
    def test_extract_tiles_list(self):
        ...
        self.assertEqual(tiles_view.get_tiles_list(), tiles_list["defaultManager"])
    ...
    def test_extract_tiles_list_selected_manager(self):
        ...
        self.assertEqual(tiles_view.get_tiles_list(), tiles_list["alternative"])
    ...
    def test_extract_tile_url_from_infos(self):
        ...
        self.assertEqual(tiles_view.get_tile_url(tile), "./@@my.tile/firstTile")
