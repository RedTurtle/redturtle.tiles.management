...
class BaseView(BrowserView):
    ...
    def get_modal_options(self):
        """Restituisce le opzioni per pat-modal come stringa JSON."""
        options = {
            "actionOptions": {
    ...
    def get_tile_url(self, tile):
        return "./@@{}/{}".format(tile.get("tile_type"), tile.get("tile_id"))
    ...
    def get_tile_size_classes(self):
        ...
        for size in sizes:
            try:
                ...
                res.append({"display_name": display_name, "css_class": css_class})
            except ValueError:
                logger.warning(
